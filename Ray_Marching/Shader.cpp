...
GLuint Util::CompileVertShader(const char* vertexsource)
{
...
GLuint Util::CompileFragShader(const char* fragmentsource)
{
...
GLuint Util::CompileShaderProgram(GLuint vertexshader , GLuint fragmentshader)
{
    GLuint m_program;
...
void Util::UseShaderProgram(GLuint program)
{
    glUseProgram(program);
}

void Util::DeleteShaderProgram(GLuint program)
{
    glDeleteProgram(program);
}

Util::Shader::Shader(const char* vertsourcepath, const char* fragsourcepath)
{
